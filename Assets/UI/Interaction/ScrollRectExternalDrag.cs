...
namespace UnityEngine.UI
{
    ...
    public class ScrollRectExternalDrag : UIBehaviour, IInitializePotentialDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        protected ScrollRectExternalDrag()
        {}
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            Vector2 localCursor;
            if (!RectTransformUtility.ScreenPointToLocalPointInRectangle(viewRect, eventData.position, Refs.I.Camera, out localCursor))
                return;
