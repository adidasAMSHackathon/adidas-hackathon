	...
	public class PointsGenerator
	{
		...
		public static void SetPointsRound(
			...
			if (data.SkipLastPosition)
				angleIncrement = (GeoUtils.TwoPI) / ((float)data.Resolution);
...
//				angle -= angleIncrement * (1.0f - partStepAmount);
		...
		public static void SetPointsStar(
			...
			float innerRadiusX = (1.0f - data.EndRadius) * outerRadiusX;
			float innerRadiusY = (1.0f - data.EndRadius) * outerRadiusY;
