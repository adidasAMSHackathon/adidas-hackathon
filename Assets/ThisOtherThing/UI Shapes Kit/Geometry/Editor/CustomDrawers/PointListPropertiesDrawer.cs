...
public class PointListPropertiesDrawer : PropertyDrawer
{
	...
	public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
	{
		...
		switch (currentGenerator) {
			...
			case PointListGeneratorData.Generators.Round:
				...
				EditorGUI.PropertyField(
					propertyPosition,
					generatorDataProp.FindPropertyRelative("Direction"),
		...
		EditorGUI.LabelField(propertyPosition, "Rounding Distance");
		float cachedX = propertyPosition.x;
		propertyPosition.x += EditorGUIUtility.singleLineHeight * 8.0f;
	...
	public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
	{
		...
		float propHeight = EditorGUIUtility.singleLineHeight * 7.5f;

		propHeight += EditorGUI.GetPropertyHeight(generatorDataProp.FindPropertyRelative("Center"));
		...
		switch (currentGenerator) {
			...
			case PointListGeneratorData.Generators.Rect:
				propHeight += EditorGUIUtility.singleLineHeight * 4.5f;
				break;
				
			case PointListGeneratorData.Generators.Round:
				propHeight += EditorGUIUtility.singleLineHeight * 11.5f;
				break;
				
			case PointListGeneratorData.Generators.RadialGraph:
				propHeight += EditorGUIUtility.singleLineHeight * 5.75f;
			...
			case PointListGeneratorData.Generators.LineGraph:
				propHeight += EditorGUIUtility.singleLineHeight * 7.0f;
			...
			case PointListGeneratorData.Generators.Star:
				propHeight += EditorGUIUtility.singleLineHeight * 6.75f;
				break;

			case PointListGeneratorData.Generators.Gear:
				propHeight += EditorGUIUtility.singleLineHeight * 10.5f;
				break;
		}
