...
var _default = function _default() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "form",
      { action: "", method: "post", className: "jsx-" + _section2.default.__scopedHash + " " + "form",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 9
        }
      ...
      _react2.default.createElement(
        "div",
        {
          className: "jsx-" + _section2.default.__scopedHash + " " + "input__group",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 10
          }
        ...
        _react2.default.createElement(
          "label",
          { htmlFor: "email-field", className: "jsx-" + _section2.default.__scopedHash + " " + "input input__label",
            __source: {
              fileName: _jsxFileName,
              lineNumber: 11
            }
        ...
        _react2.default.createElement("input", { id: "email-field", type: "email", name: "email", className: "jsx-" + _section2.default.__scopedHash,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 12
          }
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement("input", { type: "submit", value: "Subscribe", className: "jsx-" + _section2.default.__scopedHash + " " + "input input__label",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 15
          }
...
//# sourceMappingURL=3.7609d73399a923fbb35c.hot-update.js.map